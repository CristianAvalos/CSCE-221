...
private:
  ...
  void inorderHelper(Node* root, ostream& out);
  Node* searchHelper(Node* root, int obj);
  Node* insertHelper(Node* curr, int obj, int time);
  void searchTimeHelp(Node* node, int val);
};
